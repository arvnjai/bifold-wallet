...
import { AccessibilityInfo, ScrollView, StyleSheet, View, Text } from 'react-native'
    ...
    <SafeAreaModal visible={visible} transparent={true} animationType={'none'}>
      <SafeAreaView style={{ ...ListItems.credentialOfferBackground }}>
        <ScrollView style={styles.container}>
          <Text>Testing Hey in CredentialOffer 123</Text>
            
          <View style={styles.messageContainer}>
            <Text>Testing Hey in CredentialOfferAccept</Text>
