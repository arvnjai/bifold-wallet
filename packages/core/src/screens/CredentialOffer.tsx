...
const CredentialOffer: React.FC<CredentialOfferProps> = ({ navigation, credentialId }) => {
      ...
      >
        ...
        <View style={styles.footerButton}>
          <Button
            ...
            buttonType={ButtonType.CredDecline}
  ...
  return (
    <SafeAreaView style={{ flexGrow: 1 }} edges={['bottom', 'left', 'right']}>
      <Record issuedDate={credential?.createdAt} idName={overlay.metaOverlay?.name} issuer={credentialConnectionLabel || t('ContactDetails.AContact')} fields={overlay.presentationFields || []} header={header} footer={footer} />
