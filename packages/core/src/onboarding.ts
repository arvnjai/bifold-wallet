...
import { Onboarding, State } from './types/state'
...
export const isPINExplainedComplete = (didExplainPIN: boolean): OnboardingTask =>{
  return { name: Screens.ExplainPIN, completed: didExplainPIN}
}
...
export const generateOnboardingWorkflowSteps = (
  ...
  return [
    ...
    isPINExplainedComplete(didExplainPIN),
