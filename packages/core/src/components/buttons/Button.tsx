...
const ButtonImplComponent = (
  ...
  const buttonStyles = {
    [ButtonType.CredDecline]: {
      color: Buttons.credDecline,
      colorDisabled: Buttons.credDeclineDisabled,
      text: Buttons.credDeclineText,
  ...
  return (
    <TouchableOpacity
      ...
      style={[
        ...
        isActive &&
          (buttonType === ButtonType.CredDecline || buttonType === ButtonType.Secondary ) ? {
            backgroundColor: 'white',
          } :
          (buttonType === ButtonType.Decline) ? {
            backgroundColor: '#97201E',
