      ...
      case ModalUsage.CredentialOfferDecline:
        return (
          <View style={{ marginBottom: 25}}>
            ...
            <Text style={{ marginVertical: 30, fontSize: 16, color: 'black' }}>
                 {t('CredentialOffer.DeclineParagraph1')}
            </Text>
            <Text style={{ marginBottom: 30,  fontSize: 16, color: 'black' }}>{t('CredentialOffer.DeclineParagraph2')}</Text>
            <Text style={{ fontSize: 16, color: 'black'}}>{t('CredentialOffer.DeclineParagraph3')}</Text>
          </View>
        )
      case ModalUsage.ProofRequestDecline:
        return (
          ...
          <View style={styles.controlsContainer}>
            ...
            <View style={{ paddingTop: 10 }}>
              <Button
                ...
                buttonType={
                  usage === 
                    ModalUsage.ContactRemoveWithCredentials ? ButtonType.ModalPrimary : 
                    ModalUsage.CredentialOfferDecline ? ButtonType.Decline : ButtonType.ModalCritical
                }
              />
            </View>
            <View style={{ paddingTop: 10 }}>
